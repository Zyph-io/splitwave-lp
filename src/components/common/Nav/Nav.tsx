...
export default function Nav({isOpen}:Props){
    return(
      ...
      >
            ...
            <a href="#sobreNos" className="hover:text-gray-300 text-base  ">
              Sobre nós
            </a>
            <a href="#services" className="hover:text-gray-300 text-base ">
              Serviços
            </a>
            <a href="#trusted"  className="hover:text-gray-300 text-base ">
              Clientes
            </a>
            <a href="#faq" className="hover:text-gray-300 text-base ">
              FAQ
            </a>
