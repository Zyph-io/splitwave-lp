  ...
  return (
    <section className="bg-blue-900 text-white py-16 px-8">
      <div className="max-w-7xl mx-auto text-center mb-12">
        ...
        <p className="text-lg">Comissione todas as recebedores envolvidos em um único fluxo financeiro. Adicione isso à nossa conciliação, antecipação de recebíveis e controle tudo através de uma só plataforma.</p>
      </div>
      <div className="flex justify-center items-center">
        <div className="relative w-full max-w-6xl p-8 rounded-md shadow-md">
          <img
