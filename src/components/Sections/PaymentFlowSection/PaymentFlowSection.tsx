...
const PaymentFlowSection: React.FC = () => {
  return (
    <section className="flex flex-col items-center justify-center bg-blue-900 text-white pb-[229px]  max-md:pb-20  ">
      ...
      <div className=" max-w-[1455px] flex justify-center items-center ">
