...
const MainSection: React.FC = () => {
  return (
    <section className="bg-blue-900 text-white py-16 px-8 max-md:px-4">
      <div className="max-w-7xl mx-auto flex justify-start  md:flex-row items-center">
        <div className="h-[36rem] flex-1 items-start justify-start  md:w-1/2 mb-8 md:mb-0">
          <h1 className="text-4xl font-bold font-inter text-[52px] leading-[67px] mb-11 max-md:mb-5  max-md:text-2xl ">Tenha seu próprio <br /> gateway de pagamento</h1>
          <p className="text-lg mb-8 mt-11 max-md:mt-5 ">Tecnologia de ponta e segurança para ter <br /> um gateway de sucesso. Sem esforço, e com <br /> infra estrutura completa!</p>
